...
import { Check, Vote, TrendingUp, Calendar, X, ExternalLink, Share2, Facebook, Twitter, Link as LinkIcon } from 'lucide-react';
          ...
          <div className="fixed inset-0 z-[500] bg-panorama-navy/60 backdrop-blur-sm flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mt-8 p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                <span className="text-[10px] text-slate-400 truncate mr-2">https://tendenciard.com/encuestas/{showShareModal}</span>
                <button className="text-panorama-red hover:text-panorama-darkRed">
                  <LinkIcon size={16} />
                </button>
              </div>
            </motion.div>
